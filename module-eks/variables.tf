...
variable "admin_role_arns" {
  description = "Additional IAM role ARNs to grant cluster admin (system:masters) via aws-auth"
  type        = list(string)
  default     = []
}

variable "admin_user_arns" {
  description = "Additional IAM user ARNs to grant cluster admin (system:masters) via aws-auth"
  type        = list(string)
  default     = []
}
